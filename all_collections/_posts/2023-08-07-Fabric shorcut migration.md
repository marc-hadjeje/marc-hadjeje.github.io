...
To create this notebook, the code is written in Pyspark,we are going to use two features (Verti-Parquet and Optimize Write) of Fabric for optimized data writing and for subsequent better reading performance
```
# Python code 
